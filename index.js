...
const string =
  unfundedGames.length === 1
    ? `A total of <span style="color: blue">$${totalRaised.toLocaleString(
        'en-US'
      )}</span> has been raised for ${
        GAMES_JSON.length
      } games. Currently, <span style="color: blue">1 game</span> remains unfunded. We need your help to fund these amazing games!`
    : `A total of <span style="color: blue">$${totalRaised.toLocaleString(
        'en-US'
      )}</span> has been raised for ${
        GAMES_JSON.length
      } games. Currently, <span style="color: blue">${
        unfundedGames.length
      } games</span> remain unfunded. We need your help to fund these amazing games!`;
